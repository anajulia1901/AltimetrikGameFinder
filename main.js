...
<div class="one" onclick=functionModal(${allInfo.id})>
      <div class="photo1">
        <img class="photo1" src= '${allInfo.background_image}' >
         ...
         <div class="date-gif">
          <div class="infoContainer">
              ...
              <div class="textContainer">
                  ...
                  <p class="text-grid">${showGenres(allInfo)}</p>
              </div>
              <div class="line"></div>
          </div>
...
//////buttons
// function changeCardsPlacement(){
//     const cardsToColums = document.querySelector(".rect")
//     const cardsToGrids = document.querySelector(".svg")
//     const cardsPlace = docment.querySelector(".cards-container")

//     buttoncardsToColums.addEventListener(click,e =>{
