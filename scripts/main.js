...
/* fetch("https://api.rawg.io/api/games?key=a6b177c4bf7e429c91a64c0f6d30398c")
  ...
  const fetchResponse = await fetch("https://api.rawg.io/api/games?key=a6b177c4bf7e429c91a64c0f6d30398c");
  if ( fetchResponse.status !== 200){
    ...
    cardMultiplication(jsonResponse);
    initializationInfiniteScroll();
  }
} 
...
function cardConsols(cardInfo) {
  ...
  for (let i = 0; i < cardInfo.parent_platforms.length; i++) {
    if (i < 3) {
      ...
      consols += "<h3 class='title-plataform-container dots'>...<h3>";
      return consols;
    }
  }
  return consols;
...
function columnClick() {
  document.querySelector(".videogame-cards").classList.add("videogame-cards-column");
  let cardContainer = document.querySelectorAll(".one");
  let cardContainerImg = document.querySelectorAll(".photo1");
  let cardContainerTitle = document.querySelectorAll(".title-plataform-container");
  ...
  for (let i = 0; i < cardContainer.length; i++) {
    document.querySelectorAll(".desription-hidden")[i].classList.add("description-show");
  ...
  function gridClick() {
    document.querySelector(".videogame-cards").classList.remove("videogame-cards-column");
      let cardContainer = document.querySelectorAll(".one");
      let cardContainerImg = document.querySelectorAll(".photo1");
      let cardContainerTitle = document.querySelectorAll(".title-plataform-container");
      let cardContainerInfo = document.querySelectorAll(".info-container");
      ...
      for (let i = 0; i < cardContainer.length; i++) {
        document.querySelectorAll(".desription-hidden")[i].classList.remove("description-show");
...
async function functionModal(id) {
  ...
  for (let j = 0; j < allInfoGamesModal.length; j++) {
    if (
      ...
      modalTitle = allInfoGamesModal[j].querySelector(".game-title").textContent;
